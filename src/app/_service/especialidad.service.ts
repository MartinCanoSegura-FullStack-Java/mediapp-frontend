...
export class EspecialidadService extends GenericService<Especialidad> {
  ...
  /** get/set Subjects */
  getEspecialidadCambio(){ return this.especialidadCambio.asObservable(); }
  setEspecialidadCambio( especialidades: Especialidad[]){ this.especialidadCambio.next(especialidades); }
